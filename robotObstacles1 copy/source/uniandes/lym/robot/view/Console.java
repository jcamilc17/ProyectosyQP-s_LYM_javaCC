...
public class Console extends JPanel  { 
	//The Vector of commands for the history
			...
			public void actionPerformed(ActionEvent e) {
				...
				final Thread doInterpretar = new Thread() {
					public void run() {
						...
						if (resp)
  						   printOutput("Process concluded successfully!\n");
						else 
							 printOutput("Process finished with errors!\n");
						printOutput("Enter a new string of commands\n");
					}
				};
				doInterpretar.start();
			}
