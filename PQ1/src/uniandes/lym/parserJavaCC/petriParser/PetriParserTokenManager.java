/* PetriParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. PetriParserTokenManager.java */
package uniandes.lym.parserJavaCC.petriParser;
import java.util.*;

/** Token Manager. */
@SuppressWarnings ("unused")
public class PetriParserTokenManager implements PetriParserConstants {
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public PetriParserTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public PetriParserTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
